...
#define LYDEFAULT_VOID_COLOR [UIColor whiteColor]

@implementation UIColor (LYAssets)
+ (UIColor *)ly_colorWithHexString:(NSString *)stringToConvert {
    NSString *cString = [[stringToConvert stringByTrimmingCharactersInSet:[NSCharacterSet whitespaceAndNewlineCharacterSet]] uppercaseString];
    
    if ([cString length] < 6)
        return LYDEFAULT_VOID_COLOR;
...
+ (NSString *)ly_stringFromColor:(UIColor *)color {
    ...
    NSString *r = [NSString stringWithFormat:@"%@",[self ly_toHex:cs[0]*255]];
    NSString *g = [NSString stringWithFormat:@"%@",[self ly_toHex:cs[1]*255]];
    NSString *b = [NSString stringWithFormat:@"%@",[self ly_toHex:cs[2]*255]];
    return [NSString stringWithFormat:@"#%@%@%@",r,g,b];
}

+ (NSString *)ly_toHex:(int)tmpid {
    NSString *endtmp=@"";
...
- (void)ly_getRGBComponents:(CGFloat [3])components {
